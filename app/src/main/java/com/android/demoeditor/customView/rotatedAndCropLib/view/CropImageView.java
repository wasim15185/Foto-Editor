package com.android.demoeditor.customView.rotatedAndCropLib.view;

import android.content.Context;
import android.content.res.TypedArray;
import com.android.demoeditor.R;
import com.android.demoeditor.customView.rotatedAndCropLib.callback.BitmapCropCallback;
import com.android.demoeditor.customView.rotatedAndCropLib.callback.CropBoundsChangeListener;
import com.android.demoeditor.customView.rotatedAndCropLib.task.BitmapCropTask;
import com.android.demoeditor.customView.rotatedAndCropLib.util.CubicEasing;
import com.android.demoeditor.customView.rotatedAndCropLib.util.RectUtils;
...
//                .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    public Bitmap getCroppedBitmap() {
        ...
        if (currentImageRect.isEmpty()) return null;
        ...
        if (mMaxResultImageSizeX > 0 && mMaxResultImageSizeY > 0) {
            ...
            if (cropWidth > mMaxResultImageSizeX || cropHeight > mMaxResultImageSizeY) {
                ...
                float scaleY = mMaxResultImageSizeX / cropHeight;
                float resizeScale = Math.min(scaleX, scaleY);

                Bitmap resizeBitmap = Bitmap.createScaledBitmap(viewBitmap,
                        (int) (viewBitmap.getWidth() * resizeScale),
                        (int) (viewBitmap.getHeight() * resizeScale), false);


                viewBitmap.recycle();
                viewBitmap = resizeBitmap;
